...
$image_dir_path = $_SERVER['DOCUMENT_ROOT'] . "/files";// /Users/aleksandrzditovec/PhpstormProjects/labs
echo "Your path -> ".$image_dir_path."<br><br>";
...
//Выводим мена хранящихся в массиве файлов на страницу ?>
        <p><?php echo $array_files[$i]; ?></p> <?php
    }
    ?>
    <hr/>
<?php }
